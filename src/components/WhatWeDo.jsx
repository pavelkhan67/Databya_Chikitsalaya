...
const WhatWeDo = () => {
    return (
        <div className='pt-32'>
            <div className=''>
                <p className='playfair text-4xl md:text-5xl text-color pb-5'>Our Activities</p>

                <div className='shadow py-5 mx-1 md:mx-0 mb-6'>
                    <p className='playfair text-start text-color text-3xl md:text-4xl ps-1 mb-2 md:mb-0'>Education Development</p>
                    <div className='grid grid-cols-1 md:grid-cols-3 px-1 md:px-5'>
                ...
                <div className='shadow2 py-5 mx-1 md:mx-0'>
                    <p className='playfair text-color text-3xl md:text-4xl text-start md:text-end ps-1 md:ps-0 pe-1 mb-2 md:mb-0'>Women's Empowerment</p>
                    <div className='grid grid-cols-1 md:grid-cols-3 px-1 md:px-5'>
                ...
                <div className='shadow py-5 mx-1 md:mx-0 mt-6'>
                    <p className='playfair text-start text-color text-3xl md:text-4xl ps-1 mb-2 md:mb-0'>Outdoor Clinic</p>
                    <div className='grid grid-cols-1 md:grid-cols-3 px-1 md:px-5'>
                ...
                <div className='shadow2 py-5 mx-1 md:mx-0 mt-6'>
                    <p className='playfair text-color text-3xl md:text-4xl text-start md:text-end ps-1 md:ps-0 pe-1 mb-2 md:mb-0'>A Caring Haven for Seniors</p>
                    <div className='grid grid-cols-1 md:grid-cols-3 px-1 md:px-5'>
