...
const AboutUs = () => {
    return (
        <div className=' pt-32 px-1 md:px-0'>
            ...
            <div className='bg-gray mt-5 ps-1 py-5'>
                <p className='authorone text-3xl md:text-4xl text-color pb-3'>Our Objective</p>
                <div className='md:grid grid-cols-3 px-1 md:px-0 items-center'>
                    <div className='md:order-2'>
                        <img className='w-full' src={img3} alt="" />
                    </div>
                    <div className=' obj col-span-2 md:order-1 text-justify'>
                        <ul>
