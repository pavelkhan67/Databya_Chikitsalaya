...
const Footer = () => {
    return (
        <div className='mt-10'>
            <footer className="footer p-6 md:p-10 bg-color text-white text-base">
                <aside className='text-start'>
                    ...
                    <p className=''>Friends For Humanity<br />Nurturing Health, Empowering Lives, Building Compassionate Communities.</p>
                    <p>Office: 398, Cityport Building, 4<sup>th</sup> floor, Unit-E, Ashkona, Dakshinkan, Dhaka-1230</p>
                    <p>Tel: +880 2 4ff4611, Mob: +87648dgd752357/ 0156ff72739</p>
                </aside>
                <nav>
                    <header className="footer-title">Social</header>
                    <div className="grid grid-flow-col gap-4">
                        <a href='https://www.facebook.com/profile.php?id=100070150393419 '><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></a>
                        <a><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"></path></svg></a>
                    </div>
                    <div className='text-start'>
                        <p>Email : <a href="mailto:">ffff@gmail.com</a> </p>
            ...
            <div className='bg-orange-500 py-2 mb-1 md:mb-0 text-white text-sm md:text-base font-semibold flex justify-between px-2'>
                <p><span className='hidden md:inline-block'>Friends For Humanity | </span> <span className='text-sm'>Designed & Developed By</span> <a href='#' className='underline'>Adventure-Soft Ltd.</a></p>
